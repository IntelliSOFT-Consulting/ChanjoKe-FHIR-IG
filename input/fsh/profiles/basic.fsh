Alias: $inventory-items = https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/StructureDefinition/inventory-items
...
* identifier.system = "https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/basic-profile-identifiers"
...
* extension[inventory-items].extension[item].extension[0].valueCodeableConcept.coding[0].system = "https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/vaccine-codes"
