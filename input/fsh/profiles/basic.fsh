Alias: $inventory-items = http://example.org/StructureDefinition/inventory-items
...
* identifier.system = "http://example.org/basic-profile-identifiers"
...
* extension[inventory-items].extension[item].extension[0].valueCodeableConcept.coding[0].system = "http://example.org/vaccine-codes"
