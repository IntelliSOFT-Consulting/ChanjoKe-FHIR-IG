...
Alias: $body-weight-extension = https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/StructureDefinition/body-weight-extension
Alias: $contraindication-to-vaccine =  https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/StructureDefinition/contraindication-to-vaccine
Alias: $vaccine-brand =  https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/StructureDefinition/vaccine-brand
Alias: $certificate-Issued =  https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/StructureDefinition/certificate-Issued
Alias: $certificate-Issue-Date =  https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/StructureDefinition/certificate-Issue-Date
Alias: $validity-startdate-certificate =  https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/StructureDefinition/validity-startdate-certificate
Alias: $validity-endDate-certificate =  https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/StructureDefinition/validity-endDate-certificate
...
* performer.function.coding[+] = https://build.fhir.org/ig/IntelliSOFT-Consulting/ChanjoKe-FHIR-IG/tz/actors#xxx
