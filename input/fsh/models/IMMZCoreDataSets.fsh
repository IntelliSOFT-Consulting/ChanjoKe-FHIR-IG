...
Target:         "https://chanjoke.intellisoftkenya.com/fhir/ddcc/StructureDefinition/IMMZComposition"
Id:             immz-composition
...
* ^status = #active
* ^abstract = true
* ^type = "https://chanjoke.intellisoftkenya.com/fhir/fhir/StructureDefinition/vaccination-certificate-core-data-set"
...
* ^status = #active
* ^abstract = true
* ^type = "https://chanjoke.intellisoftkenya.com/fhir/fhir/StructureDefinition/vaccination-certificate-vs"
